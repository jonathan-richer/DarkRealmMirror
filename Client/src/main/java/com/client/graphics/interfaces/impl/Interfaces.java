...
interfaceId+=5000;
	...
	public static void creditsTab(TextDrawingArea[] TDA) {
		...
		addText(44502, "DarkRealm special tab", 0xff9933, true, true, -1, TDA, 2);
		addSprite(44503, 55, "Interfaces/profileview/IMAGE");
		addText(44504, "Current Donation Tokens:", 0xff9933, true, true, -1, TDA, 0);
		addHoverText(44505, "Visit online store", "@red@Donate to DarkRealm!", TDA, 0, 0xF7AA25, true, true, 168);

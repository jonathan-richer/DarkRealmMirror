...
public class Configuration {
	 ...
	 */
	public static final int CACHE_VERSION = 95; // Change this up one when making cache updates.

	public static final String CACHE_LINK = "https://static.devricher.net/darkrealm_v1.zip";
	...
	public static final String CLIENT_TITLE = "DarkRealm";
	public static final String WEBSITE = "https://darkrealm.devricher.net/";
	public static final String DEDICATED_SERVER_ADDRESS = LOCAL_HOST ? "127.0.0.1" : "70.48.127.107";//2.126.28.136
	public static final String TEST_SERVER_ADDRESS = LOCAL_HOST ? "127.0.0.1" : "70.48.127.107";//2.126.28.136

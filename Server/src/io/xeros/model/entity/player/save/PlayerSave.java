     ...
     */
                    ...
                    if (spot > -1) {
                        ...
                        switch (ReadMode) {
                            ...
                            case 2:
                                ...
                                } else if (token.equals("Ringofdarkrealm")) {
                                    p.setRingOfKoranesColletion(RingOfKoranes.CollectionLocation.valueOf(token2));

                                } else if (token.equals("RingofdarkrealmImbue")) {
        ...
        public static boolean saveGameInstant(Player p) {
            ...
            try {
                ...
                characterfile.newLine();
                characterfile.write("Ringofdarkrealm = " + p.getRingOfKoranesCollection());
                characterfile.newLine();
                characterfile.write("RingofdarkrealmImbue = " + p.getRingOfKoranesImbueCollection());
                characterfile.newLine();

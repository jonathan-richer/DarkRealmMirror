...
public class TwoOptions {
	...
	public static void handleOption1(Player c) {  //see This handles option 1 if u scroll down ull see the section two
		...
		switch (c.dialogueAction) {
			...
			case 44021://karulm rocks
				if (c.getX() == 1320 && c.getY() == 10205 || c.getX() == 1320 && c.getY() == 10206) {
					AgilityHandler.delayEmote(c, "JUMP", 1322, c.getY(), 0, 2);
				} else if (c.getX() == 1322 && c.getY() == 10205 || c.getX() == 1322 && c.getY() == 10206) {
					AgilityHandler.delayEmote(c, "JUMP", 1320, c.getY(), 0, 2);

				}
				if (c.getX() == 1311 && c.getY() == 10214 || c.getX() == 1312 && c.getY() == 10214) {
					AgilityHandler.delayEmote(c, "JUMP", 1311, 10216, 0, 2);
				} else if (c.getX() == 1311 && c.getY() == 10216 || c.getX() == 1312 && c.getY() == 10216) {
					AgilityHandler.delayEmote(c, "JUMP", 1312, 10214, 0, 2);

				}
				if (c.getX() == 1303 && c.getY() == 10206 || c.getX() == 1303 && c.getY() == 10205) {
					AgilityHandler.delayEmote(c, "JUMP", 1301, 10205, 0, 2);
				} else if (c.getX() == 1301 && c.getY() == 10206 || c.getX() == 1301 && c.getY() == 10205) {
			...
			case 9804://zahur teleport for herblore skill
				c.getPA().startTeleport(3083, 3512, 0, "modern", false);
				c.getPA().closeAllWindows();
				break;

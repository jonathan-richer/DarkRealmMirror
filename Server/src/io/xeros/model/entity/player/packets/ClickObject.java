...
public class ClickObject implements PacketType {
    ...
    private static void finishObjectClick(Player c, int option, WorldObject worldObject) {
        ...
        if (c.getToaContainer().handleClickObject(worldObject, option)) {//tombs of asamut
            return;
        }
            ...
            case 1:
				...
				switch (c.objectId) {
                    ...
                    case 16683: // ladder in edge general store up
                        ...
                        } else if (c.objectX == 2532 && c.objectY == 3545){
                            c.climbLadderTo(new Position(2532, 3546, 1));
                        }
                        break;

...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		switch (dialogue) {
			...
			case 44001:
				//sendNpcChat3("DANGER!", "crossing over this rock with no boots of stone will", "result in you being rapidly burned from the extreme heat!", c.talkingNpc, "Hydra master");
				sendStatement("@red@DANGER!", "crossing over this rock with no protective boots will", "result in you being rapidly burned from the extreme heat!");
				c.nextChat = 44021;
				break;

			case 44021:
				sendOption2("Yes", "No");
				c.dialogueAction = 44021;
				c.nextChat = 0;
				break;

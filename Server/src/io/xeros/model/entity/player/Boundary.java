...
//public static final Boundary WILDERNESS = new Boundary(1486, 1444, 3767, 3730);
	...
	public static final Boundary KARUULM1 = new Boundary(1303, 10196, 1320, 10214, 0);//First floor square area

	public static final Boundary KARUULM2 = new Boundary(1250, 10170, 1304, 10213, 0);// Wyrmm area
	public static final Boundary KARUULM3 = new Boundary(1283, 10216, 1383, 10281);// hydra area
	public static final Boundary KARUULM4 = new Boundary(1249, 10163, 1362, 10251);//// Lizards area height 1
	public static final Boundary KARUULM5 = new Boundary(1249, 10163, 1362, 10251);//top floor height 2
	public static final Boundary KARUULM6 = new Boundary(1322, 10201, 1330, 10211, 0);//next to sqaure area
	public static final Boundary[] KARUULM_ROOMS = { KARUULM2, KARUULM3 ,KARUULM4, KARUULM5, KARUULM6 };

	public static Boundary Nex = new Boundary(2910,5188,2940,5217);//New nex
